...
extern __typeof (xfce_panel_plugin_provider_set_orientation) IA__xfce_panel_plugin_provider_set_orientation __attribute((visibility("hidden")));
#define xfce_panel_plugin_provider_set_orientation IA__xfce_panel_plugin_provider_set_orientation
